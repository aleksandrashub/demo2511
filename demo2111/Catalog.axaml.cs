...
public partial class Catalog : Window
{
    ...
    {
        var pr = listAdm.SelectedItem as Prod;
        if (Helper.role == 1 && pr != null)
        {
            if (Helper.user11129.ZakazPrs.Select(x => x.IdProd).Contains(pr.IdProd))
            {
